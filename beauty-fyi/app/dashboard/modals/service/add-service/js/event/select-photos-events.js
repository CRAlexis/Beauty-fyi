...
exports.openGallery = (args, sourceForm) => {
    ...
    return new Promise((resolve, reject) => {
        ...
        mediafilepicker.on("getFiles", function (res) {
            ...
            page.getViewById("eventPhotosList").items = []
            page.getViewById("eventPhotosList").items = images;
            sourceForm.set("eventImages", images)
        })
...
exports.onItemReorderEvent = (args, sourceForm) => {
    const page = args.object.page
    const items = page.getViewById("eventPhotosList").items
    images = []
    let i = 0;
