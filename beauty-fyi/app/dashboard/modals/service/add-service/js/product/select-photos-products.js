...
exports.openGallery = (args, sourceForm) => {
    ...
    return new Promise((resolve, reject) => {
        ...
        mediafilepicker.on("getFiles", function (res) {
            ...
            page.getViewById("productPhotosList").items = []
            page.getViewById("productPhotosList").items = images;
            sourceForm.set("productImages", images)
        })
...
exports.onItemReorderProduct = (args, sourceForm) => {
    const page = args.object.page
    const items = page.getViewById("productPhotosList").items
    images = []
    let i = 0;
